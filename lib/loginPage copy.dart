...
class PeminjamCubit extends Cubit<PeminjamModel> {
  ...
  Future<int> fetchData(email, password) async {
    try {
      if (email == "" || password == "" || email == "investor") {
        return -1;
      }
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData.containsKey("data")) {
          ...
          final peminjamModel = PeminjamModel.fromJson(data).id_umkm;
          return peminjamModel;
        } else {
          return -1;
        }
...
class InvestorCubit extends Cubit<InvestorModel> {
  ...
  Future<int> fetchData2(email, password) async {
    try {
      if (email == "" || password == "") {
        return -1;
      }
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData.containsKey("data")) {
          final data = jsonData['data'] as Map<String, dynamic>;
          final peminjamModel = InvestorModel.fromJson(data).id;
          return peminjamModel;
        } else {
          return -1;
        }
