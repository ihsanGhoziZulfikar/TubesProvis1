                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          // autogrouphlkeBHx (RcwoP1KwgUGTqLt5XMHLke)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 19),
                          padding: EdgeInsets.fromLTRB(12, 15, 10.9, 15),
                          width: double.infinity,
                          height: 294,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                        ...
                        Container(
                          // autogroupnrdcrwp (RcwoXfkBCCFTYHC1XwNrDC)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 20),
                          padding: EdgeInsets.fromLTRB(12, 18, 18.47, 16),
                          width: double.infinity,
                          height: 115,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // vRt (1:2017)
                                  margin: EdgeInsets.fromLTRB(0, 0, 4.53, 0),
                                  child: Text(
                                    '4.',
                                    style: TextStyle(
                                      fontSize: 16,
                        ...
                        Container(
                          // autogroupoadtH9x (Rcwog5fprYPQTyfTmtoADt)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 19),
                          padding: EdgeInsets.fromLTRB(12, 16, 12.03, 16),
                          width: double.infinity,
                          height: 154,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // EjQ (1:2020)
                                  margin: EdgeInsets.fromLTRB(0, 0, 5.97, 0),
                                  child: Text(
                                    '5.',
                                    style: TextStyle(
                                      fontSize: 16,
                        ...
                        Container(
                          // autogroupigi2iHC (Rcwoo5UAh64kJf4sKbigi2)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 25),
                          padding: EdgeInsets.fromLTRB(12, 15, 17.47, 11),
                          width: double.infinity,
                          height: 148,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // L3g (1:2023)
                                  margin: EdgeInsets.fromLTRB(0, 0, 5.53, 0),
                                  child: Text(
                                    '6.',
                                    style: TextStyle(
                                      fontSize: 16,
                        ...
                        Container(
                          // autogroup5p3yHt2 (RcwouzSKFB8QYvXSwm5p3Y)
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // Y3G (1:2026)
                                  margin: EdgeInsets.fromLTRB(0, 0, 6.53, 0),
                                  child: Text(
                                    '7.',
                                    style: TextStyle(
                                      fontSize: 16,
                        ...
                        Container(
                          // autogroupbkw6u2E (Rcwp4erYku7QFrqNxMBKW6)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 28),
                          padding: EdgeInsets.fromLTRB(12, 14, 20.47, 12),
                          width: double.infinity,
                          height: 209,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                        ...
                        Container(
                          // autogroupff8rVPk (RcwpBjV5suQRgxBcRbfF8r)
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 20),
                          padding: EdgeInsets.fromLTRB(12, 16, 17.47, 12),
                          width: double.infinity,
                          height: 494,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                        ...
                        Container(
                          // autogroup2nunukJ (RcwpJeTERzU5wDeC3m2NUN)
                          padding: EdgeInsets.fromLTRB(11, 13, 18.47, 11),
                          width: double.infinity,
                          height: 186,
                          decoration: BoxDecoration(
                            color: Color(0xff1c355e),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // nZC (1:2036)
                                  margin: EdgeInsets.fromLTRB(0, 0, 0.53, 0),
                                  child: Text(
                                    '10.',
                                    style: TextStyle(
                                      fontSize: 16,
