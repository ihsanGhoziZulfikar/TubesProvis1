...
class ListPeminjamanAktifCubit extends Cubit<List<PeminjamanModel>> {
  String url = "http://127.0.0.1:8000/tampilkan_semua_peminjaman_aktif/";

  ListPeminjamanAktifCubit() : super([]);
