              ...
              Expanded(
                child: TabBarView(
                  children: [
                    ...
                    FutureBuilder<List<InvestorUmkmModel>>(
                      future:
                          listInvestorUmkmSedangCubit.fetchData(id_investor),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return CircularProgressIndicator();
                          ...
                          final listInvestorUmkmSedang = snapshot.data;
                          return Container(
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.only(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(top: 15.0),
                              child: ListView.builder(
                                itemCount: listInvestorUmkmSedang?.length,
                                itemBuilder: (context, index) {
                                  String foto = pendanaan[index].foto;
                                  String waktu = pendanaan[index].waktu;
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    NumberFormat.currency(
                                                      symbol: 'Rp',
                                                      decimalDigits: 0,
                                                    ).format(listInvestorUmkmSedang![
                                                                index]
                                                            .total_peminjaman -
                                                        listInvestorUmkmSedang![
                                                                index]
                                                            .dana_bayar),
                                                    style: TextStyle(
                                                        fontSize: 12,
                    ...
                    FutureBuilder<List<InvestorUmkmModel>>(
                      future: listInvestorUmkmSudahCubit.fetchData(id_investor),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return CircularProgressIndicator();
                          ...
                          final listInvestorUmkmSudah = snapshot.data;
                          return Container(
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.only(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(top: 15.0),
                              child: ListView.builder(
                                itemCount: listInvestorUmkmSudah?.length,
                                itemBuilder: (context, index) {
