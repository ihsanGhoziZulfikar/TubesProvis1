    ...
    if (nominal <= sisa_hutang) {
      ...
      try {
        ...
        for (var investorUmkmPeminjaman in investorUmkmList) {
          ...
          double danaTambahan = (nominal * investorUmkmPeminjaman.persen);
          int danaTambahanInt = danaTambahan.toInt();
          print(danaTambahanInt);

          print("bb2");

          await updateDana((investorUmkmPeminjaman.id_dana),
              (investorUmkmPeminjaman.saldo + danaTambahanInt));
